...
public class GenAtlas extends TextureAtlas{
    ...
    /** The name should be prefixed with {@code nge-} */
    public GenRegion addRegion(Fi file){
        String name = file.nameWithoutExtension();
        if(!file.path().contains("sprites/vanilla/")) name = "nge-" + name;
    ...
    /** @inheritDocs. The name should be prefixed with {@code nge-} */
    @Override
    ...
    public static class GenRegion extends AtlasRegion{
        ...
        public void save(boolean add){
            ...
            Fi file = dir.child(name.replaceFirst("nge-", "") + ".png");
